...
通过可视化的 **ReactFlow 工作流画布**，将内容策划、AI 生图、排版合成、文案生成等环节整合到同一个界面，配合 **LangGraph 多智能体系统**和 **RAG 品牌知识库**，实现从灵感输入到可发布成图的完整自动化流程。
...
| 🤖 **多智能体协同** | Planner + Designer 双图架构，6 个专业 Agent 分工协作 |
